...
# Loop que processa todas as opções de comando.
...
#- Os dois-pontos de 'a:' representa um argumento: -a FOO
#
...
# Mas ainda podem existir argumentos, como um nome de arquivos.
